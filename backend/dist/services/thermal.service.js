...
exports.createThermalViewerRoutes = exports.ThermalImageService = void 0;
...
class ThermalImageService {
     ...
     */
    static async parseThermalData(filePath) {
     ...
     */
    static async analyzeThermalImage(thermalInfo) {
     ...
     */
    static generateThermalReport(data) {
        const findings = [];
     ...
     */
    static getTempColor(temp, minTemp, maxTemp) {
...
exports.ThermalImageService = ThermalImageService;
/**
 * Thermal Viewer Routes
 */
const createThermalViewerRoutes = (db) => {
    const router = (0, express_1.Router)();
    /**
     * GET /api/viewer/thermal/:mediaId
     * Get thermal image data
     */
    router.get('/thermal/:mediaId', auth_1.verifyToken, async (req, res) => {
        try {
     ...
     */
    router.post('/thermal/analyze', auth_1.verifyToken, async (req, res) => {
        try {
     ...
     * Get thermal heatmap
     */
    router.get('/thermal/:mediaId/heatmap', auth_1.verifyToken, async (req, res) => {
        try {
            const { mediaId } = req.params;
            // Get thermal data
            const thermalData = {
...
exports.createThermalViewerRoutes = createThermalViewerRoutes;
exports.default = ThermalImageService;
